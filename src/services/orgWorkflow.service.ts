...
@Injectable()
export class OrgWorkflowService {
  ...
  public getOrgWorkflows(schemaContext: any) {
    return Observable.of(new HttpResponse({status: 200, body: this.orgWorkflows}));
  }

  public getOrgWorkflowById(id: any) {
    const obj = this.orgWorkflows.docs.find(obj => obj._id === id);

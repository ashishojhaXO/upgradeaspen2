...
import { AppDataTable2HeirarchyComponent } from './app-data-table2-heirarchy.component';
...
@NgModule({
    ...
    declarations: [
      AppDataTable2HeirarchyComponent
    ],
    exports: [AppDataTable2HeirarchyComponent],
    providers: [DomService, DataTableService, ReportsService],
    entryComponents: []
})
export class AppDataTable2HeirarchyModule { }

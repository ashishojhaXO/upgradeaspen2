    ...
    isChildRowActions: {
      ...
      htmlFunction: (row) => {
        ...
        let ngHtmlContent = '<div>' +
            ...
            '<button class="btn action-btn api-action" data-action="regenerateReceipt" ' + ( row.Status.trim() === "ERROR_PROCESSING_PAYMENT" || row.Status.trim() === "PAYMENT_PROFILE_CREATED" ? "disabled" : "" ) + ' data-order-id="'+row.internal_order_id+ '" data-line-item-id= "'+ row.internal_line_item_id +'" data-display-id="'+ row.order_id +'" style="width: auto; background: #fefefe; color: #3b3b3b; border-color: #c3c3c3; font-family: sans-serif;;"' +
            ...
            '<button class="btn action-btn api-action" data-action="recalculate" data-order-id="'+ row.internal_order_id + '" data-display-id="'+ row.order_id +'" style="width: auto; background: #fefefe; color: #3b3b3b; border-color: #c3c3c3; font-family: sans-serif;"' +
